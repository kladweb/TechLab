...
const footerSections = [
  {
    name: 'Company',
    links: [
      {name: 'Our experts', path: '/aboutschool#ourexperts'},
      {name: 'About school', path: '/aboutschool'},
      {name: 'Contacts', path: '/aboutschool#contacts'}
    ]
  },
  {
    name: 'Catalog',
    links: [
      {name: 'Courses', path: '/'},
      {name: 'Lessons', path: '/'},
      {name: 'Free lessons', path: '/'}]
  },
  {
    name: 'Career building',
    links: [
      {name: 'Career test', path: '/'},
      {name: 'Mentoring', path: '/'}
    ]
  }
];
    ...
    <StyledFooterContainer>
      {footerSections.map((section) => <StyledFooterSection key={section.name}>
        ...
        {section.links.map((section) =>
          <StyledFooterLink
            to={section.path} $isTest={section.name === 'Career test' ? true : false}
            key={section.name}>{section.name}
          </StyledFooterLink>
        )}
      </StyledFooterSection>)}

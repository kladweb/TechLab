...
export const gradient = {
  ...
  gradient50:
    "linear-gradient(270deg, rgba(101, 220, 106, 0.50) 0.2%, rgba(128, 71, 235, 0.50) 99.66%)",
...
export const typographyGradient = {
  //градиент текста
...
export const defaultBtnColor = {
  // в библиотеке он просто именуется как дефолт, но ts не принимает такое название
  violet: "#8657DD",
  yellow: "#FFB300",
  green: "#65DC6A",
  black: "#111",
